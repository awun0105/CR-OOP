...
bool cMap::printLevelUp() {
	if (level.getLevel() == 5)
	{
		...
		printMap();
		deleteOldPlayer();
		gotoXY(15, 15); cout << "OOOOOO    OOOOOOOO      OOOOOOOO      OOOOOOO    OOOOOOO    OOOOOO     OOOOOOO      TTT   TTT" << endl;
		gotoXY(15, 16); cout << "OO    O   OO     OO    OO      OO   OO         OO           OO         OO     O     TTT   TTT" << endl;
		gotoXY(15, 17); cout << "OO        OOOOOOOO    OO        OO    OOOO       OOOO       OOOOOO     OO      O    TTT   TTT" << endl;
		gotoXY(15, 18); cout << "OO    O   OO   OO      OO      OO         OO         OO     OO         OO     O     TTT   TTT" << endl;
		gotoXY(15, 19); cout << "OOOOOO    OO    OO      OOOOOOOO    OOOOOO     OOOOOO       OOOOOO     OOOOOOO     ##### ##### " << endl;
		gotoXY(125, 21); cout << "Continue ?" << endl;
